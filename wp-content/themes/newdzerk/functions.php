...
// Clean up the <head>
    ...
    if (function_exists('register_sidebar')) {
    	...
    	register_sidebar(array(
    		'name' => __('Jobs Sidebar','html5reset' ),
    		'id'   => 'jobs-sidebar',
    		'description'   => __( 'These are widgets for the Jobs Ad dynamic sidebar','html5reset' ),
    	...
    	register_sidebar(array(
    		'name' => __('Pricing Sidebar','html5reset' ),
    		'id'   => 'pricing-sidebar',
    		'description'   => __( 'These are widgets for the Pricing Ad dynamic sidebar','html5reset' ),
    		'before_widget' => '<div id="%1$s" class="widget %2$s bottom-ad-sidebar">',
    		'after_widget'  => '</div>',
    		'before_title'  => '<h2>',
    		'after_title'   => '</h2>'
