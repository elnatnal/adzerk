...
require_once dirname(__FILE__) . '/../../../StandardAnalyzer/Analyzer/Standard.php';
require_once dirname(__FILE__) . '/../../../StandardAnalyzer/TokenFilter/EnglishStemmer.php';

 /** Zend_Search_Lucene_Analysis_Analyzer_Standard */
require_once dirname(__FILE__) . '/../../../Zend/Search/Lucene/Analysis/Analyzer.php';
/** Zend_Search_Lucene_Analysis_TokenFilter_LowerCase */
require_once dirname(__FILE__) . '/../../../Zend/Search/Lucene/Analysis/TokenFilter/LowerCase.php';
