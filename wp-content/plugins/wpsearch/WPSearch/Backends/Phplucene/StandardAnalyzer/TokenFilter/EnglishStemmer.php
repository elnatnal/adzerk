...
require_once dirname(__FILE__) . '/../../StandardAnalyzer/TokenFilter/EnglishStemmer/PorterStemmer.php';
/** Zend_Search_Lucene_Analysis_TokenFilter */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Analysis/TokenFilter.php';
