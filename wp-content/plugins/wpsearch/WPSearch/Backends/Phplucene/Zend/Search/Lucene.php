...
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Exception.php';

/** Zend_Search_Lucene_Document */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Document.php';

/** Zend_Search_Lucene_Document_Html */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Document/Html.php';

/** Zend_Search_Lucene_Storage_Directory_Filesystem */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Storage/Directory/Filesystem.php';

/** Zend_Search_Lucene_Storage_File_Memory */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Storage/File/Memory.php';

/** Zend_Search_Lucene_Index_Term */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Index/Term.php';

/** Zend_Search_Lucene_Index_TermInfo */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Index/TermInfo.php';

/** Zend_Search_Lucene_Index_SegmentInfo */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Index/SegmentInfo.php';

/** Zend_Search_Lucene_Index_FieldInfo */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Index/FieldInfo.php';

/** Zend_Search_Lucene_Index_Writer */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Index/Writer.php';

/** Zend_Search_Lucene_Search_QueryParser */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Search/QueryParser.php';

/** Zend_Search_Lucene_Search_QueryHit */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Search/QueryHit.php';

/** Zend_Search_Lucene_Search_Similarity */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Search/Similarity.php';

/** Zend_Search_Lucene_Index_SegmentInfoPriorityQueue */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Index/SegmentInfoPriorityQueue.php';

/** Zend_Search_Lucene_LockManager */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/LockManager.php';



/** Zend_Search_Lucene_Interface */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Interface.php';

/** Zend_Search_Lucene_Proxy */
require_once dirname(__FILE__) . '/../../Zend/Search/Lucene/Proxy.php';
